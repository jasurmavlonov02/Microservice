    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=100, unique=True, verbose_name="титле"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.FileField(
                        null=True, upload_to="icons", verbose_name="икона"
                    ),
                ),
                (
                    "description",
                    models.CharField(
                        default="Онлайн", max_length=100, verbose_name="описание"
                    ),
                ),
                ("my_order", models.IntegerField(default=0, verbose_name="ордер")),
                (
